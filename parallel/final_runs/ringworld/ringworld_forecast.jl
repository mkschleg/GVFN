...
#SBATCH -o final_ring_forecast.out # Standard output
#SBATCH -e final_ring_forecast.err # Standard error
#SBATCH --mem-per-cpu=2000M # Memory request of 2 GB
#SBATCH --time=16:00:00 # Running time of 12 hours
#SBATCH --ntasks=128
...
const save_loc = "/home/mkschleg/scratch/GVFN/final_runs/final_ringworld_forecast"
...
@load "final_run_params/ringworld/ringworld_forecast.jld2" args_list
