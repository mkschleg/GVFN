...
#SBATCH -o ring_forecast_rmsprop.out # Standard output
#SBATCH -e ring_forecast_rmsprop.err # Standard error
...
const save_loc = "final_ringworld_forecast_rmsprop"
...
@load "final_run_params/ringworld/ringworld_forecast_rmsprop.jld2" args_list
