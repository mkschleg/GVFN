...
offpolicy_tdloss(ρ_t::Array{T, 1}, v_t::TrackedArray, c::Array{T, 1}, γ_tp1::Array{T, 1}, ṽ_tp1::Array{T, 1}) where {T<:AbstractFloat} =
    (T(0.5))*sum(ρ_t.*((v_t .- (c .+ γ_tp1.*ṽ_tp1)).^2)) * (1//length(ρ_t))
# offpolicy_tdloss(ρ_t::Array{Float32, 1}, v_t::TrackedArray, c::Array{Float32, 1}, γ_tp1::Array{Float32, 1}, ṽ_tp1::Array{Float32}) =
