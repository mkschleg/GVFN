...
function main()
    ...
    parallel_experiment_args("experiment/compassworld_rnn.jl", args_iterator; exp_module_name=:CompassWorldRNNExperiment, exp_func_name=:main_experiment, num_workers=6)
